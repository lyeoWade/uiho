  ...
  <div class="main-content">
    ...
    <div class="postlist">
      <ul id="pins">
        ...
        //echo $page;
         $count=mysql_query("select count(*) from imagearr WHERE tag like '%$keywords%' "); //获得记录总数
        ...
        $result=mysql_query("select * from imagearr WHERE tag like '%$keywords%' order by pushtime desc limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
