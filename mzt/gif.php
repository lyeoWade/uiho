...
<title>性感妹子动态图片 - 妹子图 - 第七图官网（www.images007.com）</title>
<meta name="keywords" content="第七图,妹子图,美女图片,性感美女,性感美女,少妇,黑丝美女,清纯MM,校花,妹子自拍">
...
<div class="main">
  ...
  <div class="main-content">
    <div class="currentpath">当前位置:<a href="http://www.images007.com/">第七图</a> » 性感动图</div>
    <div class="postlist">
      <ul id="pins">
        <?php 
        $id=$_GET['id'];
        ...
        //echo $page;
         $count=mysql_query("select count(*) from imagearr WHERE columns=4 "); //获得记录总数
        ...
        $result=mysql_query("select * from imagearr WHERE columns=4 order by pushtime desc limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
