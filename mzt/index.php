...
<title>第七图_妹子图_专注收集美女图片,分享美好（www.images007.com）</title>
...
<div class="main clearfix">
  ...
  <div class="main-content">
    <div class="subnav"><a href="js/" class="on">最新</a><!-- <a href="http://www.images007.com/hot">最热</a> --><!-- <a href="http://www.images007.com/best">推荐</a> --></div>
    <div class="postlist">
      <ul id="pins">
        <?php 
        $id=$_GET['id'];
        ...
        $result=mysql_query("select * from imagearr ".$setsql." order by pushtime desc limit $startCount,$perNumber"); //根据前面的计算出开始的记录和记录数
