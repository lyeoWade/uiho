$(function() {
     $("[name='my-checkbox']").bootstrapSwitch({  
            onText:'<span class="glyphicon glyphicon-ok">禁用</span>',  
            offText:'<span class="glyphicon glyphicon-remove">启用</span>'  
     });  
    // initialize all the inputs
    // $('input[type="checkbox"],[type="radio"]').not('#create-switch').bootstrapSwitch({  
    //         onText:'<span class="switch-left switch-success">1111</span>',  
    //         offText:'<span class="switch-right switch-warning">OFF222</span>'  
    //  });
